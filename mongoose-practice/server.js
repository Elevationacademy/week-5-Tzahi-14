...
// Book.find(({pages:{"$lte":500, "$gte":200}}),function(err,books){
// console.log(books)
// })
...
// Book.find({geners:"Fiction"}).skip(2).limit(5).exec(function(err,books){
// console.log(books)
// })
...
//   { weight: { "$lt": 70 } }
// ]).limit(5).exec(function (err, people) {
//   console.log(people)
// })
...
// Person.find(({kids:{"$gte":1}},{"kids.hair":"grey"}), function(err,people){
// console.log(people)
// })
